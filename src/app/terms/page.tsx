    ...
    <div className="flex min-h-screen w-full justify-center bg-muted/40 p-4 sm:p-6 md:p-8">
      <div className="w-full max-w-4xl">
        ...
        <div className="prose prose-gray mx-auto dark:prose-invert">
            ...
            <p>
                By accessing or using the LeoRecruit platform ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to all of these Terms, do not use this Service. These Terms apply to all users, including administrators, HR personnel, managers, and candidates.
            </p>

            <h2>2. Description of Service</h2>
            <p>
                LeoRecruit is an internal hiring platform designed to streamline the recruitment process. The Service includes features for posting jobs, managing candidate applications, and utilizing artificial intelligence ("AI") to match resumes with job descriptions. The Service is intended for internal company use only.
            </p>
            ...
            <p>
                LeoRecruit uses AI to provide resume matching scores and analysis. These features are provided for informational and guidance purposes only. You acknowledge that AI-generated output may not always be accurate or complete. The ultimate hiring decisions rest solely with you, and you agree not to hold LeoRecruit liable for any decisions made based on the AI analysis.
            </p>

            <h2>5. Intellectual Property</h2>
            <p>
                The Service and its original content, features, and functionality are and will remain the exclusive property of LeoRecruit and its licensors. The Service is protected by copyright, trademark, and other laws of both the United States and foreign countries.
            </p>
            ...
            <p>
                In no event shall LeoRecruit, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.
            </p>
